...
public class Mar {
    ...
    /*
    recibe una letra siempre y busca los animales que empiecen con la misma luego a cada animal le elimina dicha 
    letra que siempre sera la inicial y la va borrando del animal una vez que alguno llegue a no tener mas letras
